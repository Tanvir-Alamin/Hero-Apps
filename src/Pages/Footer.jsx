...
const Footer = () => {
  return (
    <div>
      <div>
        <footer className="footer bg sm:footer-horizontal bg-gray-900 text-white items-center py-6 px-20">
          <div className="flex flex-col">
            ...
            <p className="w-100 lg:w-130">
              ...
              With continuous updates, it provides a growing collection of apps
              to enhance efficiency, creativity, and everyday life.
            </p>
          </div>
          <nav>
      ...
      <div>
        <footer className="footer sm:footer-horizontal bg-gray-800 text-neutral-content items-center justify-center p-4">
